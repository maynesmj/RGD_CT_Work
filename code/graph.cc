...
*/
double pConstant          =      1936.38;   //+/-   0           
double pgamma             =            0.15;//   +/-   0           
double pmean              =     0.765765;   //+/-   0            	 (limited)
double pa1                =      -1912.2;   //+/-   0           
double pa2                =       6912.5;   //+/-   0              2330.27
double pa3                =      1571.58;   //+/-   0           
double pa4                =     -3498.85;   //+/-   0           

double ipConstant         =      313.194;   //+/-   0           
double ipgamma            =            0.15;//   +/-   0           
double ipmean             =     0.766401;   //+/-   0            	 (limited)
double ipa1               =     -457.031;   //+/-   0           
double ipa2               =      2005.05;   //+/-   0           
double ipa3               =     -1411.06;   //+/-   0             377.003
double ipa4               =      233.377;   //+/-   0           

double iipConstant        =      140.633 ;  //+/-   0           
double iipgamma           =            0.15;//   +/-   0           
double iipmean            =     0.764706;   //+/-   0            	 (limited)
double iipa1              =     -236.565   ;//+/-   0           
double iipa2              =       1017.2  ; //+/-   0           
double iipa3              =     -742.256 ;  //+/-   0              169.162
double iipa4              =      135.826;   //+/-   0           

double iiipConstant       =      63.6085;   //+/-   0           
double iiipgamma          =            0.15;//   +/-   0           
double iiipmean           =     0.766536;   //+/-   0            	 (limited)
double iiipa1             =     -133.202   ;//+/-   0           
double iiipa2             =      590.276  ; //+/-   0              76.5722
double iiipa3             =     -502.084 ;  //+/-   0           
double iiipa4             =      126.944;   //+/-   0           

double ivpConstant        =      46.7726;   //+/-   0           
double ivpgamma           =            0.15;//   +/-   0           
double ivpmean            =     0.769149;   //+/-   0            	 (limited)
double ivpa1              =     -74.1129   ;//+/-   0           
double ivpa2              =      320.519  ; //+/-   0           
double ivpa3              =     -253.392 ;  //+/-   0              56.3637
double ivpa4              =       60.861;   //+/-   0           

double vpConstant         =      11.5233 ;  //+/-   0           
double vpgamma            =            0.15;//   +/-   0           
double vpmean             =     0.766699 ;  //+/-   0            	 (limited)
double vpa1               =     -9.43584;   //+/-   0           
double vpa2               =      28.2353   ;//+/-   0           
double vpa3               =      25.2211  ; //+/-   0               13.8727
double vpa4               =     -25.4544 ;  //+/-   0  

/*
double pConstant          =      3483.88   +/-   0           
double pgamma             =            0   +/-   0           
double pmean              =      0.76475   +/-   0            	 (limited)
double pa1                =     -3948.67   +/-   0           
double pa2                =      14893.6   +/-   0                 4190.71
double pa3                =       19.081   +/-   0           
double pa4                =     -5418.46   +/-   0           
Warning in <Fit>: Abnormal termination of minimization.
****************************************
...
Edm                       =  5.61492e-07
NCalls                    =          266                           604.823
double ipConstant         =      502.751   +/-   0           
double ipgamma            =            0   +/-   0           
double ipmean             =     0.765019   +/-   0            	 (limited)
double ipa1               =     -850.173   +/-   0           
double ipa2               =      3774.41   +/-   0           
double ipa3               =     -2801.33   +/-   0           
double ipa4               =       517.75   +/-   0           
Warning in <Fit>: Abnormal termination of minimization.
****************************************
         Invalid FitResult  (status = 2 )
****************************************
...
Chi2                      =       265.74
NDf                       =          105
Edm                       =  4.76149e-08                            264.057
NCalls                    =          264
double iipConstant        =      219.488   +/-   0           
double iipgamma           =            0   +/-   0           
double iipmean            =     0.765078   +/-   0            	 (limited)
double iipa1              =     -442.881   +/-   0           
double iipa2              =      2021.69   +/-   0           
double iipa3              =     -1705.32   +/-   0           
double iipa4              =      418.197   +/-   0           
Warning in <Fit>: Abnormal termination of minimization.
****************************************
         Invalid FitResult  (status = 2 )
****************************************
...
Chi2                      =      207.162
NDf                       =          105
Edm                       =  7.59313e-08                              117.085
NCalls                    =          267
double iiipConstant       =      97.2823   +/-   0           
double iiipgamma          =            0   +/-   0           
double iiipmean           =      0.76605   +/-   0            	 (limited)
double iiipa1             =     -190.815   +/-   0           
double iiipa2             =      830.551   +/-   0           
double iiipa3             =     -635.862   +/-   0           
double iiipa4             =      131.509   +/-   0           
Warning in <Fit>: Abnormal termination of minimization.
****************************************
         Invalid FitResult  (status = 2 )
****************************************
...
Chi2                      =      106.095
NDf                       =          105
Edm                       =  1.04502e-08                       78.1214
NCalls                    =          266
double ivpConstant        =      64.8884   +/-   0           
double ivpgamma           =            0   +/-   0           
double ivpmean            =     0.766797   +/-   0            	 (limited)
double ivpa1              =     -137.672   +/-   0           
double ivpa2              =      600.609   +/-   0           
double ivpa3              =     -488.936   +/-   0           
double ivpa4              =      117.525   +/-   0           
Warning in <Fit>: Abnormal termination of minimization.
****************************************
         Invalid FitResult  (status = 2 )
****************************************
...
Edm                       =  4.60727e-07
NCalls                    =          262                        17.7632
double vpConstant         =      14.7681   +/-   0           
double vpgamma            =            0   +/-   0           
double vpmean             =     0.764605   +/-   0            	 (limited)
double vpa1               =     -42.7649   +/-   0           
double vpa2               =      174.423   +/-   0           
double vpa3               =      -142.59   +/-   0           
double vpa4               =      36.8272   +/-   0   
-----------------------------------------------------------------------------------------
...
*/	
	TFile f("aaaaaaaaaaaaaaaaaagraph_cu_3D_aps.root", "update");
	...
	auto pbw_g = new TGraph();
     ...
     //      double yd [6] = {4190.71, 604.823, 264.057, 117.085, 78.1214, 17.7632};
	  ...
	  //double ycu [5] = {217.02, 38.2337, 16.1869, 7.14995, 5.92987};
	  //double yd  [5] = {200.024, 27.0846, 11.5887, 5.22378, 4.61649};
 ...
 //     double yd [6] = {2608.33, 318.479, 136.191, 62.1762, 41.674, 7.89982};
      ...
      double yc [6] = {2278.86, 1701.1, 1232.57, 712.629, 569.64, 215.334};
      double yd [6] = {6194.99, 3966.18, 1941.04, 1080.41, 920.763, 307.291};
	  ...
	  double ta[5];
      double eta[5];
	  //double q2[6] = {1.5, 2.25, 2.75, 3.25, 4.0, 5.25};
      ...
      for(int i = 0; i < 5; i++){
         ...
         ta[i] = (yc[i] * 0.82) / (yd[i] * 0.88);    //0.88
         std::cout << ta[i] << std::endl;
         std::cout << yc << std::endl;
         std::cout << yd << std::endl;
         
         eta[i] = (ta[i] * sqrt((1/yc[i])+ (1/yd[i]))) / 2;
         std::cout << eta[i] << std::endl;
         //nt->AddPoint(q2[i],ta);
         std::cout << yc[i] << std::endl;
         std::cout << yd[i] << std::endl;
         std::cout << (1/yd[i])+ (1/yc[i]) << std::endl;
         std::cout << sqrt((1/yd[i])+ (1/yc[i])) << std::endl;
      }
      
      
      auto nt = new TGraphErrors(5,q2,ta,eq,eta);
