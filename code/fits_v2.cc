...
void fits_v2(){
   ...
   TFile input_15("cu_su_19107_sep_hist_5.root", "read");
    ...
    TFile f("aaaaaaaaaacu_sn_fits_sep_8_4.root", "update");

   TH1D *cu1_hist = new TH1D("sector 0 P", "Q^{2} (1-2) [GeV^{2}]", 300, 0, 2);
	cu1_hist->SetStats(0);
	cu1_hist->SetLineColor(kOrange-3);
	
	TH1D *cu2_hist = new TH1D("sector 1 P", "Q^{2} (2-2.5) [GeV^{2}]", 300, 0, 2);
	cu2_hist->SetStats(0);
	cu2_hist->SetLineColor(kOrange-3);
	
	TH1D *cu3_hist = new TH1D("sector 2 P", "Q^{2} (2.5-3) [GeV^{2}]", 300, 0, 2);
	cu3_hist->SetStats(0);
	cu3_hist->SetLineColor(kOrange-3);
	
	TH1D *cu4_hist = new TH1D("sector 3 P", "Q^{2} (3-3.5) [GeV^{2}]", 300, 0, 2);
	cu4_hist->SetStats(0);
	cu4_hist->SetLineColor(kOrange-3);
	
	TH1D *cu5_hist = new TH1D("sector 4 P", "Q^{2} (3.5-6) [GeV^{2}]", 300, 0, 2);
	cu5_hist->SetStats(0);
	cu5_hist->SetLineColor(kOrange-3);
	
	TH1D *cu6_hist = new TH1D("sector 5 P", "Cu bin6", 300, 0, 2);
	cu6_hist->SetStats(0);
        cu6_hist->SetLineColor(kOrange-3);
        
      TH1D *cu1_1_hist = (TH1D*)input_1.Get("Cu bin1");
      TH1D *cu2_1_hist = (TH1D*)input_1.Get("Cu bin2");
      TH1D *cu3_1_hist = (TH1D*)input_1.Get("Cu bin3");
      TH1D *cu4_1_hist = (TH1D*)input_1.Get("Cu bin4");
      TH1D *cu5_1_hist = (TH1D*)input_1.Get("Cu bin5");
      TH1D *cu6_1_hist = (TH1D*)input_1.Get("Cu bin6");
      TH1D *cu1_2_hist = (TH1D*)input_2.Get("Cu bin1");
      TH1D *cu2_2_hist = (TH1D*)input_2.Get("Cu bin2");
      TH1D *cu3_2_hist = (TH1D*)input_2.Get("Cu bin3");
      TH1D *cu4_2_hist = (TH1D*)input_2.Get("Cu bin4");
      TH1D *cu5_2_hist = (TH1D*)input_2.Get("Cu bin5");
      TH1D *cu6_2_hist = (TH1D*)input_2.Get("Cu bin6");
      TH1D *cu1_3_hist = (TH1D*)input_3.Get("Cu bin1");
      TH1D *cu2_3_hist = (TH1D*)input_3.Get("Cu bin2");
      TH1D *cu3_3_hist = (TH1D*)input_3.Get("Cu bin3");
      TH1D *cu4_3_hist = (TH1D*)input_3.Get("Cu bin4");
      TH1D *cu5_3_hist = (TH1D*)input_3.Get("Cu bin5");
      TH1D *cu6_3_hist = (TH1D*)input_3.Get("Cu bin6");
      TH1D *cu1_4_hist = (TH1D*)input_4.Get("Cu bin1");
      TH1D *cu2_4_hist = (TH1D*)input_4.Get("Cu bin2");
      TH1D *cu3_4_hist = (TH1D*)input_4.Get("Cu bin3");
      TH1D *cu4_4_hist = (TH1D*)input_4.Get("Cu bin4");
      TH1D *cu5_4_hist = (TH1D*)input_4.Get("Cu bin5");
      TH1D *cu6_4_hist = (TH1D*)input_4.Get("Cu bin6");
      TH1D *cu1_5_hist = (TH1D*)input_5.Get("Cu bin1");
      TH1D *cu2_5_hist = (TH1D*)input_5.Get("Cu bin2");
      TH1D *cu3_5_hist = (TH1D*)input_5.Get("Cu bin3");
      TH1D *cu4_5_hist = (TH1D*)input_5.Get("Cu bin4");
      TH1D *cu5_5_hist = (TH1D*)input_5.Get("Cu bin5");
      TH1D *cu6_5_hist = (TH1D*)input_5.Get("Cu bin6");
      TH1D *cu1_6_hist = (TH1D*)input_6.Get("Cu bin1");
      TH1D *cu2_6_hist = (TH1D*)input_6.Get("Cu bin2");
      TH1D *cu3_6_hist = (TH1D*)input_6.Get("Cu bin3");
      TH1D *cu4_6_hist = (TH1D*)input_6.Get("Cu bin4");
      TH1D *cu5_6_hist = (TH1D*)input_6.Get("Cu bin5");
      TH1D *cu6_6_hist = (TH1D*)input_6.Get("Cu bin6");
      TH1D *cu1_7_hist = (TH1D*)input_7.Get("Cu bin1");
      TH1D *cu2_7_hist = (TH1D*)input_7.Get("Cu bin2");
      TH1D *cu3_7_hist = (TH1D*)input_7.Get("Cu bin3");
      TH1D *cu4_7_hist = (TH1D*)input_7.Get("Cu bin4");
      TH1D *cu5_7_hist = (TH1D*)input_7.Get("Cu bin5");
      TH1D *cu6_7_hist = (TH1D*)input_7.Get("Cu bin6");
      TH1D *cu1_8_hist = (TH1D*)input_8.Get("Cu bin1");
      TH1D *cu2_8_hist = (TH1D*)input_8.Get("Cu bin2");
      TH1D *cu3_8_hist = (TH1D*)input_8.Get("Cu bin3");
      TH1D *cu4_8_hist = (TH1D*)input_8.Get("Cu bin4");
      TH1D *cu5_8_hist = (TH1D*)input_8.Get("Cu bin5");
      TH1D *cu6_8_hist = (TH1D*)input_8.Get("Cu bin6");
      TH1D *cu1_9_hist = (TH1D*)input_9.Get("Cu bin1");
      TH1D *cu2_9_hist = (TH1D*)input_9.Get("Cu bin2");
      TH1D *cu3_9_hist = (TH1D*)input_9.Get("Cu bin3");
      TH1D *cu4_9_hist = (TH1D*)input_9.Get("Cu bin4");
      TH1D *cu5_9_hist = (TH1D*)input_9.Get("Cu bin5");
      TH1D *cu6_9_hist = (TH1D*)input_9.Get("Cu bin6");
      TH1D *cu1_10_hist = (TH1D*)input_10.Get("Cu bin1");
      TH1D *cu2_10_hist = (TH1D*)input_10.Get("Cu bin2");
      TH1D *cu3_10_hist = (TH1D*)input_10.Get("Cu bin3");
      TH1D *cu4_10_hist = (TH1D*)input_10.Get("Cu bin4");
      TH1D *cu5_10_hist = (TH1D*)input_10.Get("Cu bin5");
      TH1D *cu6_10_hist = (TH1D*)input_10.Get("Cu bin6");
      TH1D *cu1_11_hist = (TH1D*)input_11.Get("Cu bin1");
      TH1D *cu2_11_hist = (TH1D*)input_11.Get("Cu bin2");
      TH1D *cu3_11_hist = (TH1D*)input_11.Get("Cu bin3");
      TH1D *cu4_11_hist = (TH1D*)input_11.Get("Cu bin4");
      TH1D *cu5_11_hist = (TH1D*)input_11.Get("Cu bin5");
      TH1D *cu6_11_hist = (TH1D*)input_11.Get("Cu bin6");
      TH1D *cu1_12_hist = (TH1D*)input_12.Get("Cu bin1");
      TH1D *cu2_12_hist = (TH1D*)input_12.Get("Cu bin2");
      TH1D *cu3_12_hist = (TH1D*)input_12.Get("Cu bin3");
      TH1D *cu4_12_hist = (TH1D*)input_12.Get("Cu bin4");
      TH1D *cu5_12_hist = (TH1D*)input_12.Get("Cu bin5");
      TH1D *cu6_12_hist = (TH1D*)input_12.Get("Cu bin6");
      TH1D *cu1_13_hist = (TH1D*)input_13.Get("Cu bin1");
      TH1D *cu2_13_hist = (TH1D*)input_13.Get("Cu bin2");
      TH1D *cu3_13_hist = (TH1D*)input_13.Get("Cu bin3");
      TH1D *cu4_13_hist = (TH1D*)input_13.Get("Cu bin4");
      TH1D *cu5_13_hist = (TH1D*)input_13.Get("Cu bin5");
      TH1D *cu6_13_hist = (TH1D*)input_13.Get("Cu bin6");
      TH1D *cu1_14_hist = (TH1D*)input_14.Get("Cu bin1");
      TH1D *cu2_14_hist = (TH1D*)input_14.Get("Cu bin2");
      TH1D *cu3_14_hist = (TH1D*)input_14.Get("Cu bin3");
      TH1D *cu4_14_hist = (TH1D*)input_14.Get("Cu bin4");
      TH1D *cu5_14_hist = (TH1D*)input_14.Get("Cu bin5");
      TH1D *cu6_14_hist = (TH1D*)input_14.Get("Cu bin6");
      TH1D *cu1_15_hist = (TH1D*)input_15.Get("Cu bin1");
      TH1D *cu2_15_hist = (TH1D*)input_15.Get("Cu bin2");
      TH1D *cu3_15_hist = (TH1D*)input_15.Get("Cu bin3");
      TH1D *cu4_15_hist = (TH1D*)input_15.Get("Cu bin4");
      TH1D *cu5_15_hist = (TH1D*)input_15.Get("Cu bin5");
      TH1D *cu6_15_hist = (TH1D*)input_15.Get("Cu bin6");
   ...
   TF1 *cu1_func = new TF1("cu1_fit",fitfbw,0.2,1.4,7);
