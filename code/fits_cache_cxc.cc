...
void fits_cache_cxc(){
   ...
   TFile input_1("cxc_ob_kin_18451.root", "read");
   TFile input_2("cxc_ob_kin_18452.root", "read");
   TFile input_3("cxc_ob_kin_18453.root", "read");
   TFile input_4("cxc_ob_kin_18454.root", "read");
   TFile input_5("cxc_ob_kin_18459.root", "read");
   //TFile input_6("cxc_ib_kin_18331.root", "read");
   //TFile input_7("cxc_ib_kin_18335.root", "read");
   //TFile input_8("cxc_ib_kin_18336.root", "read");
   ...
   //TFile input_15("cu_su_19107_sep_hist_3.root", "read");
    ...
    TFile f("aaaaaaaaaaaacxc_fits_sep_8_3.root", "update");
