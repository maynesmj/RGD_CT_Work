...
int zerosp = 0;
   ...
   TH1D *pip_ivy_hist = new TH1D("pip_sector 1 vy", "pip_Sector 1 vy", 200, -5, 5);
       pip_ivy_hist->SetLineColor(kCyan+1);
   TH2F *pip_ixy_hist = new TH2F("pip_sector 1 px .vs py", "pip_sector 1 px .vs py", 200, -1, 1, 200, -1, 1);
   TH1D *pip_ivz_hist = new TH1D("pip_sector 1 vz", "pip_Sector 1 vz", 200, -30, 20);
   ...
   TH1D *pip_iivy_hist = new TH1D("pip_sector 2 vy", "pip_Sector 2 vy", 200, -5, 5);
	pip_iivy_hist->SetLineColor(kOrange+1);
   TH2F *pip_iixy_hist = new TH2F("pip_sector 2 vx .vs vy", "pip_vxvy" , 500, 0.6, 11, 500, 0, 0.3);
   TH1D *pip_iivz_hist = new TH1D("pip_sector 2 vz", "pip_Sector 2 vz", 200, -30, 20);
   ...
   TH1D *pip_iiivy_hist = new TH1D("pip_sector 3 vy", "pip_Sector 3 vy", 200, -5, 5);
   ...
   TH1D *pip_iiivz_hist = new TH1D("pip_sector 3 vz", "pip_Sector 3 vz", 200, -30, 20);
   ...
   TH1D *pip_ivvy_hist = new TH1D("pip_sector 4 vy", "pip_Sector 4 vy", 200, -5, 5);
	pip_ivvy_hist->SetLineColor(kGreen);
   TH2F *pip_ivxy_hist = new TH2F("pip_sector 4 vx .vs vy", "pip_sector 4 vx .vs vy", 200, -1, 1, 200, -1, 1);
   TH1D *pip_ivvz_hist = new TH1D("pip_sector 4 vz", "pip_Sector 4 vz", 200, -30, 20);
   	pip_ivvz_hist->SetLineColor(kGreen);

   TH1F *pip_vvx_hist = new TH1F("pip_sector 5 vx", "pip_Sector 5 vx", 200, -5, 5);
	pip_vvx_hist->SetLineColor(kBlue);
   TH1D *pip_vvy_hist = new TH1D("pip_sector 5 vy", "pip_Sector 5 vy", 200, -5, 5);
	pip_vvy_hist->SetLineColor(kBlue);
   TH2F *pip_vxy_hist = new TH2F("pip_sector 5 vx .vs vy", "pip_sector 5 vx .vs vy", 200, -1, 1, 200, -1, 1);
   TH1D *pip_vvz_hist = new TH1D("pip_sector 5 vz", "pip_Sector 5 vz", 200, -30, 20);
   	pip_vvz_hist->SetLineColor(kBlue);

   TH1F *pip_vivx_hist = new TH1F("pip_sector 6 vx", "pip_Sector 6 vx", 200, -5, 5);
	pip_vivx_hist->SetLineColor(kMagenta+1);
   TH1D *pip_vivy_hist = new TH1D("pip_sector 6 vy", "pip_Sector 6 vy", 200, -5, 5);
   ...
   TH1D *pip_vivz_hist = new TH1D("pip_sector 6 vz", "pip_Sector 6 vz", 200, -30, 20);
   ...
   TH1D *pim_ivy_hist = new TH1D("pim_sector 1 vy", "pim_Sector 1 vy", 200, -5, 5);
         pim_ivy_hist->SetLineColor(kCyan+1);
   TH2F *pim_ixy_hist = new TH2F("pim_sector 1 px .vs py", "pim_sector 1 px .vs py", 200, -1, 1, 200, -1, 1);
   TH1D *pim_ivz_hist = new TH1D("pim_sector 1 vz", "pim_Sector 1 vz", 200, -30, 20);
   ...
   TH1D *pim_iivy_hist = new TH1D("pim_sector 2 vy", "pim_Sector 2 vy", 200, -5, 5);
	 pim_iivy_hist->SetLineColor(kOrange+1);
   TH2F *pim_iixy_hist = new TH2F("pim_sector 2 vx .vs vy", "pim_vxvy" , 500, 0.6, 11, 500, 0, 0.3);
   TH1D *pim_iivz_hist = new TH1D("pim_sector 2 vz", "pim_Sector 2 vz", 200, -30, 20);
   ...
   TH1D *pim_iiivy_hist = new TH1D("pim_sector 3 vy", "pim_Sector 3 vy", 200, -5, 5);
   ...
   TH1D *pim_iiivz_hist = new TH1D("pim_sector 3 vz", "pim_Sector 3 vz", 200, -30, 20);
   ...
   TH1D *pim_ivvy_hist = new TH1D("pim_sector 4 vy", "pim_Sector 4 vy", 200, -5, 5);
	 pim_ivvy_hist->SetLineColor(kGreen);
   TH2F *pim_ivxy_hist = new TH2F("pim_sector 4 vx .vs vy", "pim_sector 4 vx .vs vy", 200, -1, 1, 200, -1, 1);
   TH1D *pim_ivvz_hist = new TH1D("pim_sector 4 vz", "pim_Sector 4 vz", 200, -30, 20);
   	pim_ivvz_hist->SetLineColor(kGreen);

   TH1F *pim_vvx_hist = new TH1F("pim_sector 5 vx", "pim_Sector 5 vx", 200, -5, 5);
	 pim_vvx_hist->SetLineColor(kBlue);
   TH1D *pim_vvy_hist = new TH1D("pim_sector 5 vy", "pim_Sector 5 vy", 200, -5, 5);
	 pim_vvy_hist->SetLineColor(kBlue);
   TH2F *pim_vxy_hist = new TH2F("pim_sector 5 vx .vs vy", "pim_sector 5 vx .vs vy", 200, -1, 1, 200, -1, 1);
   TH1D *pim_vvz_hist = new TH1D("pim_sector 5 vz", "pim_Sector 5 vz", 200, -30, 20);
   	pim_vvz_hist->SetLineColor(kBlue);

   TH1F *pim_vivx_hist = new TH1F("pim_sector 6 vx", "pim_Sector 6 vx", 200, -5, 5);
	 pim_vivx_hist->SetLineColor(kMagenta+1);
   TH1D *pim_vivy_hist = new TH1D("pim_sector 6 vy", "pim_Sector 6 vy", 200, -5, 5);
   ...
   TH1D *pim_vivz_hist = new TH1D("pim_sector 6 vz", "pim_Sector 6 vz", 200, -30, 20);
   	pim_vivz_hist->SetLineColor(kMagenta+1);
   
   TH1D *echi_hist = new TH1D("echi", "electron chi2 pid", 200, -40, 40);
   TH1D *pipchi_hist = new TH1D("pipchi", "pip chi2 pid", 200, -40, 40);
   TH1D *pimchi_hist = new TH1D("pimchi", "pim chi2 pid", 200, -40, 40);
...
//9110, 9111, 9112, 9113, 9114, 9115, 9117, 9118, 9119
   ...
   TFile f("rm_cusn_pass0v7_63_test.root", "update"); //cusn_pass0v7_63_test.root

    std::ifstream v3("rge_align.list");  //cusn_skim_pass0v6_300.list   rge_align.list    cusn_calv9_skim.list
         std::string line;
...
//std::cout << "1 th" << std::endl;
 ...
 int e_num = 0;
  ...
  // for(int redo = 0; redo < 4; redo++){
      for(int p = 0; p < v3_a.size(); p++){ // for(int p = 0; p < v3_a.size(); p++){    301   34 37
        std::string inFile;
            inFile =  v3_a[p];
...
//ietot_p->AddPoint(x,y);
      ...
      // std::cout << pid_pip_count << std::endl;
         if( pid_e_count > 0 ){               //This ensures that only the events with all three particle will be looked at
            ...
            vz = a_vz[address];
            if(vz >= (-8.477 - 3*0.675) && vz <= (-8.477 + 3*0.675)){
	       ...
	       pip_hist->Fill(a_pip_sect[i]); 
			...
			//count_3++;		
                 ...
                 float pim_mul = 110000.0; // 3.0 4.0 5.0
...
*/
   ...
   iivx_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1, 0.1, 0.1);
   ...
   ivvy_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1, 0.1, 0.1);
   ...
   TF1 *pip_ivx_fit = new TF1("pip_ivx_fit", "gaus(0)+pol4(3)", pip_ivx_hist->GetBinCenter(pip_ivx_hist->GetMaximumBin()) - 1.5, pip_ivx_hist->GetBinCenter(pip_ivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_iivx_fit = new TF1("pip_iivx_fit", "gaus(0)+pol4(3)", pip_iivx_hist->GetBinCenter(pip_iivx_hist->GetMaximumBin()) - 1.5, pip_iivx_hist->GetBinCenter(pip_iivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_iiivx_fit = new TF1("pip_iiivx_fit", "gaus(0)+pol4(3)", pip_iiivx_hist->GetBinCenter(pip_iiivx_hist->GetMaximumBin()) - 1.5, pip_iiivx_hist->GetBinCenter(pip_iiivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_ivvx_fit = new TF1("pip_ivvx_fit", "gaus(0)+pol4(3)", pip_ivvx_hist->GetBinCenter(pip_ivvx_hist->GetMaximumBin()) - 1.5, pip_ivvx_hist->GetBinCenter(pip_ivvx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_vvx_fit = new TF1("pip_vvx_fit", "gaus(0)+pol4(3)", pip_vvx_hist->GetBinCenter(pip_vvx_hist->GetMaximumBin()) - 1.5, pip_vvx_hist->GetBinCenter(pip_vvx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_vivx_fit = new TF1("pip_vivx_fit", "gaus(0)+pol4(3)", pip_vivx_hist->GetBinCenter(pip_vivx_hist->GetMaximumBin()) - 1.5, pip_vivx_hist->GetBinCenter(pip_vivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_ivy_fit = new TF1("pip_ivy_fit", "gaus(0)+pol4(3)", pip_ivy_hist->GetBinCenter(pip_ivy_hist->GetMaximumBin()) - 1.5, pip_ivy_hist->GetBinCenter(pip_ivy_hist->GetMaximumBin()) + 1.5);
   pip_ivy_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1);
   ...
   TF1 *pip_iivy_fit = new TF1("pip_iivy_fit", "gaus(0)+pol4(3)", pip_iivy_hist->GetBinCenter(pip_iivy_hist->GetMaximumBin()) - 1.5, pip_iivy_hist->GetBinCenter(pip_iivy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_iiivy_fit = new TF1("pip_iiivy_fit", "gaus(0)+pol4(3)", pip_iiivy_hist->GetBinCenter(pip_iiivy_hist->GetMaximumBin()) - 1.5, pip_iiivy_hist->GetBinCenter(pip_iiivy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_ivvy_fit = new TF1("pip_ivvy_fit", "gaus(0)+pol4(3)", pip_ivvy_hist->GetBinCenter(pip_ivvy_hist->GetMaximumBin()) - 1.5, pip_ivvy_hist->GetBinCenter(pip_ivvy_hist->GetMaximumBin()) + 1.5);
   pip_ivvy_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1);
   ...
   TF1 *pip_vvy_fit = new TF1("pip_vvy_fit", "gaus(0)+pol4(3)", pip_vvy_hist->GetBinCenter(pip_vvy_hist->GetMaximumBin()) - 1.5, pip_vvy_hist->GetBinCenter(pip_vvy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pip_vivy_fit = new TF1("pip_vivy_fit", "gaus(0)+pol4(3)", pip_vivy_hist->GetBinCenter(pip_vivy_hist->GetMaximumBin()) - 1.5, pip_vivy_hist->GetBinCenter(pip_vivy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_ivx_fit = new TF1("pim_ivx_fit", "gaus(0)+pol4(3)", pim_ivx_hist->GetBinCenter(pim_ivx_hist->GetMaximumBin()) - 1.5, pim_ivx_hist->GetBinCenter(pim_ivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_iivx_fit = new TF1("pim_iivx_fit", "gaus(0)+pol4(3)", pim_iivx_hist->GetBinCenter(pim_iivx_hist->GetMaximumBin()) - 1.5, pim_iivx_hist->GetBinCenter(pim_iivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_iiivx_fit = new TF1("pim_iiivx_fit", "gaus(0)+pol4(3)", pim_iiivx_hist->GetBinCenter(pim_iiivx_hist->GetMaximumBin()) - 1.5, pim_iiivx_hist->GetBinCenter(pim_iiivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_ivvx_fit = new TF1("pim_ivvx_fit", "gaus(0)+pol4(3)", pim_ivvx_hist->GetBinCenter(pim_ivvx_hist->GetMaximumBin()) - 1.5, pim_ivvx_hist->GetBinCenter(pim_ivvx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_vvx_fit = new TF1("pim_vvx_fit", "gaus(0)+pol4(3)", pim_vvx_hist->GetBinCenter(pim_vvx_hist->GetMaximumBin()) - 1.5, pim_vvx_hist->GetBinCenter(pim_vvx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_vivx_fit = new TF1("pim_vivx_fit", "gaus(0)+pol4(3)", pim_vivx_hist->GetBinCenter(pim_vivx_hist->GetMaximumBin()) - 1.5, pim_vivx_hist->GetBinCenter(pim_vivx_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_ivy_fit = new TF1("pim_ivy_fit", "gaus(0)+pol4(3)", pim_ivy_hist->GetBinCenter(pim_ivy_hist->GetMaximumBin()) - 1.5, pim_ivy_hist->GetBinCenter(pim_ivy_hist->GetMaximumBin()) + 1.5);
   pim_ivy_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1);
   ...
   TF1 *pim_iivy_fit = new TF1("pim_iivy_fit", "gaus(0)+pol4(3)", pim_iivy_hist->GetBinCenter(pim_iivy_hist->GetMaximumBin()) - 1.5, pim_iivy_hist->GetBinCenter(pim_iivy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_iiivy_fit = new TF1("pim_iiivy_fit", "gaus(0)+pol4(3)", pim_iiivy_hist->GetBinCenter(pim_iiivy_hist->GetMaximumBin()) - 1.5, pim_iiivy_hist->GetBinCenter(pim_iiivy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_ivvy_fit = new TF1("pim_ivvy_fit", "gaus(0)+pol4(3)", pim_ivvy_hist->GetBinCenter(pim_ivvy_hist->GetMaximumBin()) - 1.5, pim_ivvy_hist->GetBinCenter(pim_ivvy_hist->GetMaximumBin()) + 1.5);
   pim_ivvy_fit->SetParameters(0.1, 0, 0.1, 0.001, 0.1, 0.1);
   ...
   TF1 *pim_vvy_fit = new TF1("pim_vvy_fit", "gaus(0)+pol4(3)", pim_vvy_hist->GetBinCenter(pim_vvy_hist->GetMaximumBin()) - 1.5, pim_vvy_hist->GetBinCenter(pim_vvy_hist->GetMaximumBin()) + 1.5);
   ...
   TF1 *pim_vivy_fit = new TF1("pim_vivy_fit", "gaus(0)+pol4(3)", pim_vivy_hist->GetBinCenter(pim_vivy_hist->GetMaximumBin()) - 1.5, pim_vivy_hist->GetBinCenter(pim_vivy_hist->GetMaximumBin()) + 1.5);
   ...
   vy_hist->Write();
      ...
      TF1 *vz_fit = new TF1("vz_fit", "gaus(0)+gaus(3)+pol1(6)", -23.0, -11.0);
   ...
   vzz_hist->Write();
      ...
      TF1 *pip_vx_fit = new TF1("pip_vx_fit", "gaus(0)+pol4(3)", pip_vx_hist->GetBinCenter(pip_vx_hist->GetMaximumBin()) - 1.5, pip_vx_hist->GetBinCenter(pip_vx_hist->GetMaximumBin()) + 1.5);
   ...
   pip_vx_hist->Write();
      ...
      TF1 *pip_vy_fit = new TF1("pip_vy_fit", "gaus(0)+pol4(3)", pip_vy_hist->GetBinCenter(pip_vy_hist->GetMaximumBin()) - 1.5, pip_vy_hist->GetBinCenter(pip_vy_hist->GetMaximumBin()) + 1.5);
   ...
   pip_vy_hist->Write();
      ...
      TF1 *pip_vz_fit = new TF1("pip_vz_fit", "gaus(0)+gaus(3)+pol1(6)", -10, 0);
   //pip_vz_fit->SetParameters(0.1, 7.5, 0.1, 0.1, 2.5, 0.1);
   TF1 *g11 = new TF1 ("m11", "gaus", -10.0, -5);
   TF1 *g21 = new TF1 ("m21", "gaus", -5, 0);
   gStyle->SetOptFit(1);
   pip_vz_hist->Fit(g11, "R");
   pip_vz_hist->Fit(g21, "R+");
   Double_t par1[8];
   g11->GetParameters(&par1[0]);
   g21->GetParameters(&par1[3]);
   pip_vz_fit->SetParameters(par1);
   ...
   pip_vz_hist->Write();
      ...
      TF1 *pim_vx_fit = new TF1("pim_vx_fit", "gaus(0)+pol4(3)", pim_vx_hist->GetBinCenter(pim_vx_hist->GetMaximumBin()) - 1.5, pim_vx_hist->GetBinCenter(pim_vx_hist->GetMaximumBin()) + 1.5);
   ...
   pim_vx_hist->Write();
      ...
      TF1 *pim_vy_fit = new TF1("pim_vy_fit", "gaus(0)+pol4(3)", pim_vy_hist->GetBinCenter(pim_vy_hist->GetMaximumBin()) - 1.5, pim_vy_hist->GetBinCenter(pim_vy_hist->GetMaximumBin()) + 1.5);
   ...
   //pim_vz_fit->SetParameters(0.1, 7.5, 0.1, 0.1, 2.5, 0.1);
   TF1 *g12 = new TF1 ("m12", "gaus", -10.0, -5);
   TF1 *g22 = new TF1 ("m22", "gaus", -5, 0);
   gStyle->SetOptFit(1);
   pim_vz_hist->Fit(g12, "R");
   pim_vz_hist->Fit(g22, "R+");
   Double_t par2[8];
   g12->GetParameters(&par2[0]);
   g22->GetParameters(&par2[3]);
   pim_vz_fit->SetParameters(par2);
   ...
   pip_vx_hist->Draw("HIST");
   pip_ivx_hist->Draw("HIST Same");
   ...
   pim_vx_hist->Draw("HIST");
   pim_ivx_hist->Draw("HIST Same");
