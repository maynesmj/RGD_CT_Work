...
int main(){
   ...
   TH2F *samp_hist = new TH2F("smvsp", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp_hist->SetStats(0);
   
   TH2F *samp1_hist = new TH2F("smvsp1", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp1_hist->SetStats(0);
   
   TH2F *samp2_hist = new TH2F("smvsp2", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp2_hist->SetStats(0);
   
   TH2F *samp3_hist = new TH2F("smvsp3", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp3_hist->SetStats(0);
   
   TH2F *samp4_hist = new TH2F("smvsp4", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp4_hist->SetStats(0);
   
   TH2F *samp5_hist = new TH2F("smvsp5", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   samp5_hist->SetStats(0);
   
   TH2F *samp6_hist = new TH2F("smvsp6", "Sample Fraction vs momentum", 200, 0, 10, 200, 0, 0.4);
   ...
   samw_hist->SetStats(0);
    TH2F *thve_hist = new TH2F("thve", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist->SetStats(0);
   
   TH2F *thve_hist1 = new TH2F("thve1", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist1->SetStats(0);
   TH2F *thve_hist2 = new TH2F("thve2", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist2->SetStats(0);
   TH2F *thve_hist3 = new TH2F("thve3", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist3->SetStats(0);
   TH2F *thve_hist4 = new TH2F("thve4", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist4->SetStats(0);
   TH2F *thve_hist5 = new TH2F("thve5", "#theta vs edge", 200, 0, 60, 200, 5, 35);
   thve_hist5->SetStats(0);
   TH2F *thve_hist6 = new TH2F("thve6", "#theta vs edge", 200, 0, 60, 200, 5, 35);
...
TH1F *pimwtzp_hist = new TH1F("#Pi^{-} Momentum With W, -t & Zh cut", "#Pi^{-} Momentum With W, -t & Zh cut", 200, 0, 10);
   ...
   TH2F *xy_uncut = new TH2F("xy_uncut", "OB LD_{2} DC Region 1 Electron Uncut", 200, -150, 150, 200, -150, 150);
   TH2F *xy_cut = new TH2F("xy_cut", "OB LD_{2} DC Region 1 Electron Cut", 200, -150, 150, 200, -150, 150);
...
//9110, 9111, 9112, 9113, 9114, 9115, 9117, 9118, 9119
   ...
   TFile f("ctest_pass0v11_ldob_25_r1.root", "update"); //cusn_pass0v7_63_test.root
...
//int trkc = 0;
            ...
            for(int ec = 0; ec < ne; ec++){
				...
				track_sect = track.getInt("sector", tkrow);
			...
			ytr = s * x0 + c * y0;
			 ...
			 if(track_sect == 1){
			 	thve_hist1->Fill(edge, the_n);
			 } else if(track_sect == 2){
			 	thve_hist2->Fill(edge, the_n);
			 } else if(track_sect == 3){
			 	thve_hist3->Fill(edge, the_n);
			 } else if(track_sect == 4){
			 	thve_hist4->Fill(edge, the_n);
			 } else if(track_sect == 5){
			 	thve_hist5->Fill(edge, the_n);
			 } else if(track_sect == 6){
			 	thve_hist6->Fill(edge, the_n);
			 }
			...
			ytr = s * x0 + c * y0;
			 ...
			 //}
        		...
        		lv_cal = lv_cal + cal.getFloat("lv", row);
...
//   samwd_g->Fit(samwd_gfit);
 ...
 //  samwu_g->Fit(samwu_gfit);
   ...
   thve_hist->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist->Draw();
   thve_hist->Write();
   
   thve_hist1->GetXaxis()->SetTitle("edge [cm]");
   thve_hist1->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist1->Draw();
   thve_hist1->Write();
   
   thve_hist2->GetXaxis()->SetTitle("edge [cm]");
   thve_hist2->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist2->Draw();
   thve_hist2->Write();
   
   thve_hist3->GetXaxis()->SetTitle("edge [cm]");
   thve_hist3->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist3->Draw();
   thve_hist3->Write();
   
   thve_hist4->GetXaxis()->SetTitle("edge [cm]");
   thve_hist4->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist4->Draw();
   thve_hist4->Write();
   
   thve_hist5->GetXaxis()->SetTitle("edge [cm]");
   thve_hist5->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist5->Draw();
   thve_hist5->Write();
   
   thve_hist6->GetXaxis()->SetTitle("edge [cm]");
   thve_hist6->GetYaxis()->SetTitle("#theta_{DC} [dec]");
   thve_hist6->Draw();
   thve_hist6->Write();
  ...
  auto thveu_g = new TGraph();
   ...
   xy_uncut->GetXaxis()->SetTitle("x [cm]");
   xy_uncut->GetYaxis()->SetTitle("y [cm]");
   xy_uncut->Draw();
   xy_uncut->Write();
   
   
   xy_cut->GetXaxis()->SetTitle("x [cm]");
   xy_cut->GetYaxis()->SetTitle("y [cm]");
   xy_cut->Draw();
   xy_cut->Write();
